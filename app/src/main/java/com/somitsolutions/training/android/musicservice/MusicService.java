...
public class MusicService extends Service {
	...
	public void onCreate() {
		...
		final Intent iBroadcastIntent = new Intent(getApplicationContext(), MusicPlayerStatusBroadcastReceiver.class);
		// Set up the Media Player
		mPlayer = MediaPlayer.create(this, R.raw.tumkodekhatoyehkhayal);
		...
		if (null != mPlayer) {
			...
			mPlayer.setOnCompletionListener(new OnCompletionListener() {
				...
				public void onCompletion(MediaPlayer mp) {
					...
					//send the broadcast
					sendBroadcast(iBroadcastIntent);
	...
	public int onStartCommand(Intent intent, int flags, int startid) {
		...
		//mBroadcastReceiver = intent.getParcelableExtra("broadcastreceiver");
